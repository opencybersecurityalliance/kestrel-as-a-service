...
echo -e "192.168.50.7 kaas-nfs\n192.168.50.8 kaas-ansible-controller\n192.168.50.9 minikube\n192.168.50.10 kaas-master-1\n192.168.50.13 kaas-node-1" >> /etc/hosts

# Installing necessary packages 

sudo apt update && sudo apt -y install curl wget net-tools iputils-ping python3-pip sshpass nfs-common
